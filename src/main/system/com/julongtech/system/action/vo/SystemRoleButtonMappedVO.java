...
public class SystemRoleButtonMappedVO  implements Serializable {
	 /**
		...
		public String toString() {
			return "SystemRoleButtonMappedVO [mappedId=" + mappedId + ", roleId=" + roleId + ", menuId=" + menuId
					+ ", buttonId=" + buttonId + ", orgId=" + orgId + ", mappedDesc=" + mappedDesc
					+ ", mappedCreateTime=" + mappedCreateTime + ", userId=" + userId + ", mappedUpdateTime="
