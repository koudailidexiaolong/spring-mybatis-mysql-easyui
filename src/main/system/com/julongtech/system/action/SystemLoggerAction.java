...
public class SystemLoggerAction {
	...
	@RequestMapping(value="/getLoggerListByPage",method={RequestMethod.GET,RequestMethod.POST})
	@ResponseBody
	@LoggerProxy(method = LoggerMethod.SELECT,module = LoggerModule.SYSTEM_LOGGER,description="分页查询登录日志")
	public Map<String,Object> getLoggerListByPage(SystemLoggerVO systemLoggerVO,PageParam<SystemLoggerDTO> page){
