...
public class AuthorizeAction {
	...
	public String loadAddMenu(SystemRoleMenuMappedVO systemRoleMenuMappedVO,Model model){
		...
		try {
			...
			buttonList = this.systemButtonServiceImpl.getSystemButtonList(systemButtonVO, userSession);
	...
	public String loadAddRole(SystemUserRoleMappedVO systemUserRoleMappedVO,Model model){
		...
		try {
			...
			List<SystemRoleDTO>  roleList = this.systemRoleServiceImpl.getRoleList(systemRoleVO, userSession);
	...
	public Map<String,Object> deleteRoleUser(SystemUserRoleMappedVO systemUserRoleMappedVO){
		...
		try {
			...
			UserSession userSession = (UserSession) this.httpSession.getAttribute("userSession");
			//根据用户编号删除映射关系
			result = this.systemUserRoleMappedServiceImpl.deleteUserRoleMapped(systemUserRoleMappedVO, userSession);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			logger.error("【系统权限配置模块】根据角色查询映射关系的方法发生异常", e);
		}
	...
	public Map<String,Object> getRoleUser(SystemUserRoleMappedVO systemUserRoleMappedVO){
		...
		try {
			//根据用户查询映射关系表数据
			UserSession userSession = (UserSession) this.httpSession.getAttribute("userSession");
			List<SystemUserRoleMappedDTO>  mappedList = this.systemUserRoleMappedServiceImpl.getUserRoleMappedList(systemUserRoleMappedVO, userSession);
