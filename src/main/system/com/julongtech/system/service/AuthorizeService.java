...
public interface AuthorizeService {
	 ...
	 */
	public abstract List<SystemMenuDTO> getUserMenu(SystemUserVO systemUserVO,UserSession userSession) throws Exception;
	 ...
	 */
	public abstract List<SystemButtonDTO> getUserMenuButton(SystemUserVO systemUserVO,UserSession userSession) throws Exception;
}
