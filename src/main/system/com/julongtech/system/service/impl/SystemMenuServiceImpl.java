...
public class SystemMenuServiceImpl implements SystemMenuService {
	 ...
	 */
	@Override
	public List<SystemMenuDTO> getMenuListByPage(SystemMenuVO systemMenuVO,UserSession userSession)
			throws Exception {
	 ...
	 */
	@Override
	public List<SystemMenuDTO> getMenuListTree(SystemMenuVO systemMenuVO,UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
		//一级菜单
		SystemMenuDTO systemMenuDTO = new SystemMenuDTO();
		...
		for (SystemMenuDTO menu2 : menuList) {
			List<SystemMenuDTO> menuList2 = this.getMenuList(new SystemMenuVO(null, menu2.getMenuId()), userSession);
			for (SystemMenuDTO menu3 : menuList2) {
				List<SystemMenuDTO> menuList3 = this.getMenuList(new SystemMenuVO(null, menu3.getMenuId()), userSession);
	 ...
	 */
	@Override
	public List<SystemMenuDTO> getMenuList(SystemMenuVO systemMenuVO,UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
	 ...
	 */
	@Override
	public SystemMenuDTO getSystemMenu(SystemMenuVO systemMenuVO,UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
	...
	public int saveSystemMenu(SystemMenuVO systemMenuVO, UserSession userSession) throws Exception {
		...
		systemMenuInfo.setMenuStatus(systemMenuVO.getMenuStatus());
		systemMenuInfo.setMenuOrder(systemMenuVO.getMenuOrder());
		systemMenuInfo.setUserId(userSession.getSystemUser().getUserId());
	 ...
	 */
	@Override
	public int deleteSystemMenu(SystemMenuVO systemMenuVO,UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
		int result = -1;
	 ...
	 */
	@Override
	public int deleteAllSystemMenu(SystemMenuVO systemMenuVO,UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
		int result = -1;
	 ...
	 */
	@Override
	public int validateMenuExist(SystemMenuVO systemMenuVO, UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
