...
public class RedisCacheServiceImpl implements RedisCacheService {
	...
	public boolean refreshMenuCache() throws Exception{
		...
		List<SystemMenuDTO> menuList = this.systemMenuServiceImpl.getMenuList(systemMenuVO, null);
	...
	public boolean refreshButtonCache() throws Exception {
		...
		List<SystemButtonDTO> menuList = this.systemButtonServiceImpl.getSystemButtonList(systemButtonVO, null);
	...
	public boolean refreshUserCache() throws Exception{
		...
		List<SystemUserDTO>  userList = this.systemUserServiceImpl.getUserList(systemUserVO, null);
	...
	public boolean refreshDictionaryCache()throws Exception{
		...
		List<SystemDictionaryDTO> dictionaryDTOList =  this.systemDictionaryServiceImpl.getSystemDictionaryByType(systemDictionaryVO, null);
