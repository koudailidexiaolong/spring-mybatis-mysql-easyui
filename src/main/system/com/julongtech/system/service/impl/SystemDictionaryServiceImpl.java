...
public class SystemDictionaryServiceImpl implements SystemDictionaryService {
	...
	@Override
	public List<SystemDictionaryDTO> getSystemDictionaryList(SystemDictionaryVO systemDictionaryVO, UserSession userSession)
			throws Exception {
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<SystemDictionaryDTO> getSystemDictionaryByParentCode(SystemDictionaryVO systemDictionaryVO, UserSession userSession)
			throws Exception {
		logger.debug("【数据字典】-查询数据信息集合输入参数systemDictionaryVO：{}",systemDictionaryVO);
		SystemDictionaryDTO systemDictionaryDTO = new SystemDictionaryDTO();
		systemDictionaryDTO.setDictionaryParentCode(systemDictionaryVO.getDictionaryParentCode());
	...
	@Override
	public List<SystemDictionaryDTO> getSystemDictionaryByType(SystemDictionaryVO systemDictionaryVO, UserSession userSession)	throws Exception {
		// TODO Auto-generated method stub
		logger.debug("【数据字典】-查询数据信息集合输入参数systemDictionaryVO：{}",systemDictionaryVO);
		SystemDictionaryDTO systemDictionaryDTO = new SystemDictionaryDTO();
		systemDictionaryDTO.setDictionaryCode(systemDictionaryVO.getDictionaryCode());
	...
	@Override
	public SystemDictionaryDTO getSystemDictionary(SystemDictionaryVO systemDictionaryVO, UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
	...
	@Override
	public List<SystemDictionaryDTO> getSystemDictionaryListByPage(SystemDictionaryVO systemDictionaryVO, UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
	...
	public int saveSystemDictionary(SystemDictionaryVO systemDictionaryVO,UserSession userSession) throws Exception {
		...
		systemDictionaryInfo.setDictionaryCreateUserId(userSession.getSystemUser().getUserId());
	...
	public int updateSystemDictionary(SystemDictionaryVO systemDictionaryVO,UserSession userSession) throws Exception {
		...
		systemDictionaryInfo.setDictionaryType(systemDictionaryVO.getDictionaryType());
		systemDictionaryInfo.setDictionaryDesc(systemDictionaryVO.getDictionaryDesc());
		systemDictionaryInfo.setDictionaryUpdateUserId(userSession.getSystemUser().getUserId());
	...
	@Override
	public int deleteSystemDictionary(SystemDictionaryVO systemDictionaryVO,UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
	 ...
	 */
	@Override
	public int validateSystemDictionary(SystemDictionaryVO systemDictionaryVO,UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
