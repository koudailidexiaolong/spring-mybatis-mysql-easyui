...
public class SystemRoleServiceImpl implements SystemRoleService {
	 ...
	 */
	@Override
	public List<SystemRoleDTO> getRoleListByPage(SystemRoleVO systemRoleVO,UserSession userSession)
			throws Exception {
	 ...
	 */
	@Override
	public List<SystemRoleDTO> getRoleList(SystemRoleVO systemRoleVO,UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
	 ...
	 */
	@Override
	public SystemRoleDTO getSystemRole(SystemRoleVO systemRoleVO,UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
	...
	public int saveSystemRole(SystemRoleVO systemRoleVO, UserSession userSession) throws Exception {
		...
		if(null != userSession){
			systemRoleInfo.setRoleCreateUserId(userSession.getSystemUser().getUserId());
		}
	...
	public int updateSystemRole(SystemRoleVO systemRoleVO,UserSession userSession) throws Exception {
		...
		systemRoleInfo.setRoleType(systemRoleVO.getRoleType());
		if(null != userSession){
			systemRoleInfo.setRoleUpdateUserId(userSession.getSystemUser().getUserId());
		}
	 ...
	 */
	@Override
	public int deleteSystemRole(SystemRoleVO systemRoleVO,UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
	 ...
	 */
	@Override
	public int deleteAllSystemRole(SystemRoleVO systemRoleVO,UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
		int result = -1;
	 ...
	 */
	@Override
	public int deleteSystemRoleList(List<SystemRoleVO> roleList,UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
	 ...
	 */
	@Override
	public int validateRoleExist(SystemRoleVO systemRoleVO, UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
