...
public class SystemLoggerExceptionServiceImpl implements SystemLoggerExceptionService {
	...
	public int saveSystemLoggerException(SystemLoggerExceptionVO systemLoggerExceptionVO, UserSession userSession)throws Exception {
		...
		if(userSession != null){
			systemLoggerExceptionInfo.setUserId(userSession.getSystemUser().getUserId());
			systemLoggerExceptionInfo.setUserName(userSession.getSystemUser().getUserName());
			systemLoggerExceptionInfo.setOrgId(userSession.getSystemUser().getOrgId());
		}
