...
public class SystemUserServiceImpl implements SystemUserService {
	 ...
	 */
	@Override
	public int deleteUser(SystemUserVO systemUserVO,UserSession userSession) throws Exception {
	 ...
	 */
	@Override
	public List<SystemUserDTO> getUserListByPage(SystemUserVO systemUserVO, UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
	...
	public int saveUser(SystemUserVO systemUserVO, UserSession userSession)	throws Exception {
		...
		if(null != userSession){
			systemUserInfo.setUserCreateUserId(userSession.getSystemUser().getUserId());
		}
	...
	public int updateUser(SystemUserVO systemUserVO, UserSession userSession)	throws Exception {
		...
		systemUserInfo.setUserStatus(systemUserVO.getUserStatus());
		if(null != userSession){
			systemUserInfo.setUserUpdateUserId(userSession.getSystemUser().getUserId());
		}
		//更新的参数
	 ...
	 */
	@Override
	public SystemUserDTO getUser(SystemUserVO systemUserVO,UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
	 ...
	 */
	@Override
	public int deleteUserList(List<SystemUserVO> userList,UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
		int result = -1;
		logger.debug("【用户模块】-删除用户信息的开始...");
		for (SystemUserVO user : userList) {
			//删除用户
			result = this.deleteUser(user, userSession);
			result ++;
		}
		return result;
	}
	 ...
	 */
	@Override
	public int validatePassword(SystemUserVO systemUserVO,UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
	 ...
	 */
	@Override
	public int countUser(SystemUserVO systemUserVO, UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
	...
	@Override
	public List<SystemUserDTO> getUserList(SystemUserVO systemUserVO, UserSession userSession) throws Exception {
		// TODO Auto-generated method stub
