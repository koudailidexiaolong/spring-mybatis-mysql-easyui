 ...
 */
@Service
public class SystemLoggerExptionServiceImpl implements
		SystemLoggerExptionService {
	...
	@Override
	public int deleteSystemLoggerExption(
			List<SystemLoggerExptionVO> systemLoggerExptionVO,
