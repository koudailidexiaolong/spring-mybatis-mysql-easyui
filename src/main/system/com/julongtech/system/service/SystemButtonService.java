...
public interface SystemButtonService {
	 ...
	 */
	public abstract List<SystemButtonDTO> selectSystemButtonListByPage(SystemButtonVO systemButtonVO,UserSession userSession) throws Exception;
	 ...
	 */
	public abstract SystemButtonDTO getSystemButton(SystemButtonVO systemButtonVO,UserSession userSession) throws Exception;
	 ...
	 */
	public abstract int deleteSystemButton(SystemButtonVO systemButtonVO,UserSession userSession) throws Exception;
	 ...
	 */
	public abstract List<SystemButtonDTO> getSystemButtonList(SystemButtonVO systemButtonVO,UserSession userSession) throws Exception;
	 ...
	 */
	public abstract int validateButtonExist(SystemButtonVO systemButtonVO,UserSession userSession) throws Exception;
