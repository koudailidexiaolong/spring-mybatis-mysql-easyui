...
public interface SystemMenuService {
	 ...
	 */
	public abstract List<SystemMenuDTO> getMenuListByPage(SystemMenuVO systemMenuVO,UserSession userSession) throws Exception;
	 ...
	 * @date 2016-7-6 上午11:50:43
	 */
	public abstract List<SystemMenuDTO> getMenuList(SystemMenuVO systemMenuVO,UserSession userSession) throws Exception;
	 ...
	 * @date 2016-7-6 上午11:50:43
	 */
	public abstract List<SystemMenuDTO>  getMenuListTree(SystemMenuVO systemMenuVO,UserSession userSession) throws Exception;
	 ...
	 */
	public abstract SystemMenuDTO getSystemMenu(SystemMenuVO systemMenuVO,UserSession userSession) throws Exception;
	 ...
	 * @date 2016-7-20 下午06:18:47
	 */
	public abstract int deleteSystemMenu(SystemMenuVO systemMenuVO,UserSession userSession) throws Exception;
	/**
	 * 级联删除菜单基本信息的方法
	 * @param SystemMenuVO 菜单对象
	 * @param userSession 当前登录用户
	 ...
	 * @date 2016-7-20 下午06:18:47
	 */
	public abstract int deleteAllSystemMenu(SystemMenuVO systemMenuVO,UserSession userSession) throws Exception;
	 ...
	 */
	public abstract int validateMenuExist(SystemMenuVO systemMenuVO,UserSession userSession) throws Exception;
}
