...
public interface SystemOrgService {
	 ...
	 */
	public abstract List<SystemOrgDTO> getSystemOrgList(SystemOrgVO systemOrgVO,UserSession userSession) throws Exception;
	 ...
	 * @date 2017-1-9 下午07:22:26
	 */
	public abstract List<SystemOrgDTO> getSystemOrgListByPage(SystemOrgVO systemOrgVO,UserSession userSession) throws Exception;
	 ...
	 */
	public abstract SystemOrgDTO getSystemOrg(SystemOrgVO systemOrgVO,UserSession userSession) throws Exception;
	 ...
	 */
	public abstract int deleteSystemOrg(SystemOrgVO systemOrgVO,UserSession userSession) throws Exception;
	 ...
	 * @date 2017-1-9 下午07:31:44
	 */
	public abstract int validateSystemOrg(SystemOrgVO systemOrgVO,UserSession userSession) throws Exception;
	 ...
	 * @date 2017-1-9 下午07:31:44
	 */
	public abstract Map<String,Object> importOrgInfoList(List<SystemOrgVO> systemOrgList,UserSession userSession) throws Exception;
	 ...
	 * @date 2017-1-9 下午07:22:26
	 */
	public abstract List<SystemOrgDTO> getSystemOrgParentList(SystemOrgVO systemOrgVO,UserSession userSession) throws Exception;
