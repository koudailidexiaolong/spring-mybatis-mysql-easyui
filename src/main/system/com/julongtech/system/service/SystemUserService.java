...
public interface SystemUserService {
	 ...
	 */
	public abstract List<SystemUserDTO> getUserListByPage(SystemUserVO systemUserVO,UserSession userSession) throws Exception;
	 ...
	 */
	public abstract int deleteUser(SystemUserVO systemUserVO,UserSession userSession) throws Exception;
	 ...
	 */
	public abstract SystemUserDTO getUser(SystemUserVO systemUserVO,UserSession userSession) throws Exception;
	 ...
	 * @date 2017-1-6 上午10:27:09
	 */
	public abstract int deleteUserList(List<SystemUserVO> userList,UserSession userSession) throws Exception;
	 ...
	 */
	public abstract int validatePassword(SystemUserVO systemUserVO,UserSession userSession) throws Exception;
	 ...
	 * @date 2017-10-17 下午7:33:07
	 */
	public abstract int countUser(SystemUserVO systemUserVO,UserSession userSession) throws Exception;
	 ...
	 */
	public abstract List<SystemUserDTO> getUserList(SystemUserVO systemUserVO, UserSession userSession) throws Exception;
